	...
	private void PasteData(ScriptData sd, GameObject go){
		...
		if(temp==null){
			...
			// else if(reactType[react]=="Add new script")
				// temp=UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(go, "Assets/SDTK/Editor/_EditorTools/CopyScriptData.cs (290,10)", sd.scriptName) as MonoBehaviour;
			else return;
		}
